...
# Step 5
echo -e "\e[32m**Orai will install in $HOME/orai/orai/.oraid**\e[0m"
...
CONFIG_DIR="$HOME/orai/orai/.oraid/config/"
...
User              = $USER
Type              = simple
ExecStart         = $HOME/go/bin/oraid start --home $HOME/orai/orai/.oraid
TimeoutStopSec    = 300
LimitNOFILE       = 65535
Restart           = on-failure
RestartSec        = 10
...
# Step 22
check_directory "$HOME/orai/orai/.oraid" ".oraid directory is created" ".oraid directory not found, installation failed"
...
# Check again $HOME/orai/orai/.oraid/config/config.toml and app.toml files
echo "Config and app configuration in progress..."
check_directory "$HOME/orai/orai/.oraid/config/" "config.toml file found" "config.toml file not found, configuration failed"
check_directory "$HOME/orai/orai/.oraid/config/" "app.toml file found" "app.toml file not found, configuration failed"
check_directory "$HOME/orai/orai/.oraid/config/" "client.toml file found" "client.toml file not found, configuration failed"
...
change_config_values "$HOME/orai/orai/.oraid/config"
...
# Display the message
echo -e "\e[32m**Orai successfully installed in $HOME/orai/orai/.oraid**\e[0m"
